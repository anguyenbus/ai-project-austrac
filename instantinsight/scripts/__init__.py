"""
Scripts module for instantinsight project.
...
Available scripts:
- setup_local_rag.py: Setup the local RAG system for PostgreSQL
...
- add_custom_examples.py: Add custom training examples to the RAG system
